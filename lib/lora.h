...
#define REG_RX_NB_BYTES             0x13            //IMPORTANTE (usado no receptor)
...
#define REG_DETECT_OPT              0x31            //IMPORTANTE (usado no receptor)
#define	REG_DETECTION_THRESHOLD     0x37            //IMPORTANTE (usado no receptor)
